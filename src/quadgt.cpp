...
//---------------------------------------------------------------------------
// Name        : QuadBankClick
// Description : Handle user clicking to change the bank
// Parameters  : 
// Returns     : NONE.
//---------------------------------------------------------------------------
...
void QuadGT_Redraw_Reverb(const UInt8 prog)
{
  ...
  {
    MainForm->ReverbType->ItemIndex = QuadtGT_Bank[bank][prog].reverb.mode;

    MainForm->ReverbInput1->ItemIndex = QuadtGT_Bank[bank][prog].reverb.input_1;
    MainForm->ReverbInput2->ItemIndex = QuadtGT_Bank[bank][prog].reverb.input_2;

    RedrawVertBarTextU8(MainForm->ReverbPreDelay, MainForm->ReverbPreDelayVal, QuadtGT_Bank[bank][prog].reverb.predelay, 1);
    
    RedrawHorizBarTextS8(MainForm->ReverbInMix, MainForm->ReverbInMixVal, QuadtGT_Bank[bank][prog].reverb.input_mix);
    RedrawHorizBarTextS8(MainForm->ReverbPreMix, MainForm->ReverbPreMixVal, QuadtGT_Bank[bank][prog].reverb.predelay_mix);

    RedrawVertBarTextU8(MainForm->ReverbLowDecay,  MainForm->ReverbLowDecayVal,  QuadtGT_Bank[bank][prog].reverb.low_decay, 0);
    RedrawVertBarTextU8(MainForm->ReverbHighDecay, MainForm->ReverbHighDecayVal, QuadtGT_Bank[bank][prog].reverb.high_decay, 0);
    RedrawVertBarTextU8(MainForm->ReverbDecay,     MainForm->ReverbDecayVal,     QuadtGT_Bank[bank][prog].reverb.decay, 0);

    RedrawVertBarTextU8(MainForm->ReverbDiffusion,  MainForm->ReverbDiffusionVal, QuadtGT_Bank[bank][prog].reverb.diffusion,0);

    RedrawVertBarTextU8(MainForm->ReverbDensity,  MainForm->ReverbDensityVal, QuadtGT_Bank[bank][prog].reverb.density,0);

    MainForm->ReverbGateOn->Checked = (QuadtGT_Bank[bank][prog].reverb.gate==1) ? TRUE : FALSE;
    RedrawVertBarTextU8(MainForm->ReverbGateHold,  MainForm->ReverbGateHoldVal, QuadtGT_Bank[bank][prog].reverb.gate_hold,0);
    RedrawVertBarTextU8(MainForm->ReverbGateRelease,  MainForm->ReverbGateReleaseVal, QuadtGT_Bank[bank][prog].reverb.gate_release,0);
    RedrawVertBarTextU8(MainForm->ReverbGateLevel,  MainForm->ReverbGateLevelVal, QuadtGT_Bank[bank][prog].reverb.gated_level,0);
  }
}
...
void QuadGT_Redraw_Delay(const UInt8 prog)
{
  ...
  if (MainForm->PanelQuadDelay->Visible == TRUE)
  {
    ...
    else if (mode == DELAYMODE3_MULTITAP)
    {
      ...
      RedrawVertBarTextU8(MainForm->TapDelay,    MainForm->TapDelayVal, QuadtGT_Bank[bank][prog].tap.delay[tap], 0);
      RedrawVertBarTextU8(MainForm->TapPan,      MainForm->TapPanVal, QuadtGT_Bank[bank][prog].tap.pan[tap], 0);
      RedrawVertBarTextU8(MainForm->TapVol,      MainForm->TapVolVal, QuadtGT_Bank[bank][prog].tap.volume[tap], 0);
      RedrawVertBarTextU8(MainForm->TapFeedback, MainForm->TapFeedbackVal, QuadtGT_Bank[bank][prog].tap.feedback[tap], 0);
    }
  }
}
...
void QuadGT_Redraw_Pitch(const UInt8 prog)
{
      ...
      (QuadtGT_Bank[bank][prog].config==CFG3_5BANDEQ_PITCH_DELAY))
  {
    ...
    MainForm->PitchMode->ItemIndex = QuadtGT_Bank[bank][prog].pitch.mode;
    MainForm->PitchInput->ItemIndex = QuadtGT_Bank[bank][prog].pitch.input;
    ...
    RedrawVertBarTextU8(MainForm->PitchFeedback, MainForm->PitchFeedbackVal, QuadtGT_Bank[bank][prog].pitch.feedback, 0);
  }
  else if (QuadtGT_Bank[bank][prog].config==CFG1_LESLIE_DELAY_REVERB)
  {
  ...
  else if (QuadtGT_Bank[bank][prog].config==CFG5_RINGMOD_DELAY_REVERB)
  {
    ...
    RedrawVertBarTextU16(MainForm->RingModSS,    MainForm->RingModSSVal,    QuadtGT_Bank[bank][prog].ring_mod.shift, 0);
    RedrawVertBarTextS8(MainForm->RingModInMix, MainForm->RingModInMixVal, QuadtGT_Bank[bank][prog].ring_mod.in_mix);
    RedrawVertBarTextS8(MainForm->RingModOutMix, MainForm->RingModOutMixVal, QuadtGT_Bank[bank][prog].ring_mod.out_mix);
  }
...
void QuadGT_Redraw_Eq(const UInt8 prog)
{
  ...
  if ((QuadtGT_Bank[bank][prog].config==CFG0_EQ_PITCH_DELAY_REVERB) || (QuadtGT_Bank[bank][prog].config==CFG4_3BANDEQ_REVERB))
  {
    ...
    MainForm->Eq3Mode->ItemIndex =QuadtGT_Bank[bank][prog].eq.mode;

    MainForm->EqFreq1->Position = QuadtGT_Bank[bank][prog].eq.low_freq;
    MainForm->EqFreq1Val->Text = AnsiString(QuadtGT_Bank[bank][prog].eq.low_freq);
    MainForm->EqAmp1->Position = -1 * (QuadtGT_Bank[bank][prog].eq.low_amp - MainForm->EqAmp1->Max);
    MainForm->Eq3Amp1Val->Text = AnsiString(((double)(QuadtGT_Bank[bank][prog].eq.low_amp - MainForm->EqAmp1->Max))/20.0);

    MainForm->EqFreq2->Position = QuadtGT_Bank[bank][prog].eq.mid_freq;
    MainForm->EqFreq2Val->Text = AnsiString(QuadtGT_Bank[bank][prog].eq.mid_freq);
    MainForm->EqAmp2->Position = -1 * (QuadtGT_Bank[bank][prog].eq.mid_amp - MainForm->EqAmp2->Max);
    MainForm->Eq3Amp2Val->Text = AnsiString(((double)(QuadtGT_Bank[bank][prog].eq.mid_amp - MainForm->EqAmp2->Max))/20.0);
    MainForm->EqQ2->Position = QuadtGT_Bank[bank][prog].eq.mid_q;
    MainForm->EqQ2Val->Text = AnsiString(QuadtGT_Bank[bank][prog].eq.mid_q);

    MainForm->EqFreq3->Position = QuadtGT_Bank[bank][prog].eq.high_freq;
    MainForm->EqFreq3Val->Text = AnsiString(QuadtGT_Bank[bank][prog].eq.high_freq);
    MainForm->EqAmp3->Position = -1 * (QuadtGT_Bank[bank][prog].eq.high_amp - MainForm->EqAmp3->Max);
    MainForm->Eq3Amp3Val->Text = AnsiString(((double)(QuadtGT_Bank[bank][prog].eq.high_amp - MainForm->EqAmp3->Max))/20.0);
  ...
  if (QuadtGT_Bank[bank][prog].config==CFG3_5BANDEQ_PITCH_DELAY) 
  {
    ...
    MainForm->Eq5Mode->ItemIndex =QuadtGT_Bank[bank][prog].eq.mode;

    MainForm->Eq5Freq1->Position = QuadtGT_Bank[bank][prog].eq.low_freq;
    MainForm->Eq5Freq1Val->Text = AnsiString(QuadtGT_Bank[bank][prog].eq.low_freq);
    MainForm->Eq5Amp1->Position = -1 * (QuadtGT_Bank[bank][prog].eq.low_amp - MainForm->Eq5Amp1->Max);
    MainForm->Eq5Amp1Val->Text = AnsiString(((double)(QuadtGT_Bank[bank][prog].eq.low_amp - MainForm->Eq5Amp1->Max))/20.0);

    MainForm->Eq5Freq2->Position = QuadtGT_Bank[bank][prog].eq.low_mid_freq;
    MainForm->Eq5Freq2Val->Text = AnsiString(QuadtGT_Bank[bank][prog].eq.low_mid_freq);
    MainForm->Eq5Amp2->Position = -1 * (QuadtGT_Bank[bank][prog].eq.low_mid_amp - MainForm->Eq5Amp2->Max);
    MainForm->Eq5Amp2Val->Text = AnsiString((double)(QuadtGT_Bank[bank][prog].eq.low_mid_amp - MainForm->Eq5Amp2->Max)/20.0);
    MainForm->Eq5Q2->Position = QuadtGT_Bank[bank][prog].eq.low_mid_q;
    MainForm->Eq5Q2Val->Text = AnsiString(QuadtGT_Bank[bank][prog].eq.low_mid_q);

    MainForm->Eq5Freq3->Position = QuadtGT_Bank[bank][prog].eq.mid_freq;
    MainForm->Eq5Freq3Val->Text = AnsiString(QuadtGT_Bank[bank][prog].eq.mid_freq);
    MainForm->Eq5Amp3->Position = -1 * (QuadtGT_Bank[bank][prog].eq.mid_amp - MainForm->Eq5Amp3->Max);
    MainForm->Eq5Amp3Val->Text = AnsiString((double)(QuadtGT_Bank[bank][prog].eq.mid_amp - MainForm->Eq5Amp3->Max)/20.0);
    MainForm->Eq5Q3->Position = QuadtGT_Bank[bank][prog].eq.mid_q;
    MainForm->Eq5Q3Val->Text = AnsiString(QuadtGT_Bank[bank][prog].eq.mid_q);

    MainForm->Eq5Freq4->Position = QuadtGT_Bank[bank][prog].eq.high_mid_freq;
    MainForm->Eq5Freq4Val->Text = AnsiString(QuadtGT_Bank[bank][prog].eq.high_mid_freq);
    MainForm->Eq5Amp4->Position = -1 * (QuadtGT_Bank[bank][prog].eq.high_mid_amp - MainForm->Eq5Amp4->Max);
    MainForm->Eq5Amp4Val->Text = AnsiString((double)(QuadtGT_Bank[bank][prog].eq.high_mid_amp - MainForm->Eq5Amp4->Max)/20.0);
    MainForm->Eq5Q4->Position = QuadtGT_Bank[bank][prog].eq.high_mid_q;
    MainForm->Eq5Q4Val->Text = AnsiString(QuadtGT_Bank[bank][prog].eq.high_mid_q);

    MainForm->Eq5Freq5->Position = QuadtGT_Bank[bank][prog].eq.high_freq;
    MainForm->Eq5Freq5Val->Text = AnsiString(QuadtGT_Bank[bank][prog].eq.high_freq);
    MainForm->Eq5Amp5->Position = -1 * (QuadtGT_Bank[bank][prog].eq.high_amp - MainForm->Eq5Amp5->Max);
    MainForm->Eq5Amp5Val->Text = AnsiString((double)(QuadtGT_Bank[bank][prog].eq.high_amp - MainForm->Eq5Amp5->Max)/20.0);
  }
  else 
  {
  ...
  if (QuadtGT_Bank[bank][prog].config==CFG2_GEQ_DELAY) 
  {
    ...
    MainForm->GEQPreset->ItemIndex =QuadtGT_Bank[bank][prog].eq.preset;

    // TBD: If using preset, disable sliders and display preset amplitudes
   
    MainForm->GEQ_16Hz->Position =-1*QuadtGT_Bank[bank][prog].eq.graphic_16hz;
    MainForm->GEQ_32Hz->Position =-1*QuadtGT_Bank[bank][prog].eq.graphic_32hz;
    MainForm->GEQ_62Hz->Position =-1*QuadtGT_Bank[bank][prog].eq.graphic_62hz;
    MainForm->GEQ_126Hz->Position=-1*QuadtGT_Bank[bank][prog].eq.graphic_126hz;
    MainForm->GEQ_250Hz->Position=-1*QuadtGT_Bank[bank][prog].eq.graphic_250hz;
    MainForm->GEQ_500Hz->Position=-1*QuadtGT_Bank[bank][prog].eq.graphic_500hz;
    MainForm->GEQ_1KHz->Position =-1*QuadtGT_Bank[bank][prog].eq.graphic_1khz;
    MainForm->GEQ_2KHz->Position =-1*QuadtGT_Bank[bank][prog].eq.graphic_2khz;
    MainForm->GEQ_4KHz->Position =-1*QuadtGT_Bank[bank][prog].eq.graphic_4khz;
    MainForm->GEQ_8KHz->Position =-1*QuadtGT_Bank[bank][prog].eq.graphic_8khz;
    MainForm->GEQ_16KHz->Position=-1*QuadtGT_Bank[bank][prog].eq.graphic_16khz;
...
void QuadGT_Redraw_Preamp(const UInt8 prog)
{
  ...
  MainForm->PreTone->ItemIndex=QuadtGT_Bank[bank][prog].preamp.tone;
  ...
  // Noise Gate (0-17)
  MainForm->PreGate->Position=MainForm->PreGate->Max-QuadtGT_Bank[bank][prog].preamp.gate;
  MainForm->PreGateVal->Text = AnsiString(QuadtGT_Bank[bank][prog].preamp.gate);
  ...
  {
    MainForm->PreOutLevel->Position = MainForm->PreOutLevel->Max-QuadtGT_Bank[bank][prog].preamp.out_level;
    MainForm->PreOutVal->Text = AnsiString(QuadtGT_Bank[bank][prog].preamp.out_level);
...
void QuadGT_Redraw_Resonator(const UInt8 prog)
{
  ...
  if ((QuadtGT_Bank[bank][prog].config==CFG0_EQ_PITCH_DELAY_REVERB) && (QuadtGT_Bank[bank][prog].eq.mode == EQMODE1_EQ_PLUS_RESONATOR))
  {
    // 2 Resonators
  ...
  else if ((QuadtGT_Bank[bank][prog].config == CFG3_5BANDEQ_PITCH_DELAY) && (QuadtGT_Bank[bank][prog].eq.mode == EQMODE1_EQ_PLUS_RESONATOR))
  {
    // 5 Resonators
    MainForm->QuadResonator->Visible=TRUE;
...
void __fastcall TMainForm::QuadParamChange(TObject *Sender)
{
  ...
  else if (Sender == MainForm->PreGate) VertBarChangeU8((TTrackBar *)Sender, MainForm->PreGateVal, &QuadtGT_Bank[bank][prog].preamp.gate);
  else if (Sender == MainForm->PreOutLevel) VertBarChangeU8((TTrackBar *)Sender, MainForm->PreOutVal, &QuadtGT_Bank[bank][prog].preamp.out_level);

  // 3 Band Eq
  // TBD: EqFreq1 EqFreq2 EqQ2 EqFreq3
  else if (Sender == MainForm->Eq3Mode)
  {
    QuadtGT_Bank[bank][prog].eq.mode = MainForm->Eq3Mode->ItemIndex;
    QuadGT_Redraw_Eq(prog);
    QuadGT_Redraw_Resonator(prog);
  }
  else if (Sender == MainForm->EqAmp1) EqBarChange(MainForm->EqAmp1, MainForm->Eq3Amp1Val, &QuadtGT_Bank[bank][prog].eq.low_amp);
  else if (Sender == MainForm->EqAmp2) EqBarChange(MainForm->EqAmp2, MainForm->Eq3Amp2Val, &QuadtGT_Bank[bank][prog].eq.mid_amp);
  else if (Sender == MainForm->EqAmp3) EqBarChange(MainForm->EqAmp3, MainForm->Eq3Amp3Val, &QuadtGT_Bank[bank][prog].eq.high_amp);

  else if (Sender == MainForm->EqFreq1) HorizBarChange(MainForm->EqFreq1, MainForm->EqFreq1Val, &QuadtGT_Bank[bank][prog].eq.low_freq);
  else if (Sender == MainForm->EqFreq2) HorizBarChange(MainForm->EqFreq2, MainForm->EqFreq2Val, &QuadtGT_Bank[bank][prog].eq.mid_freq);
  else if (Sender == MainForm->EqFreq3) HorizBarChange(MainForm->EqFreq3, MainForm->EqFreq3Val, &QuadtGT_Bank[bank][prog].eq.high_freq);

  else if (Sender == MainForm->EqQ2) HorizBarChangeU8(MainForm->EqQ2, MainForm->EqQ2Val, &QuadtGT_Bank[bank][prog].eq.mid_q);

  // 5 Band Eq
  else if (Sender == MainForm->Eq5Mode)
  {
    QuadtGT_Bank[bank][prog].eq.mode = MainForm->Eq5Mode->ItemIndex;
    QuadGT_Redraw_Eq(prog);
    QuadGT_Redraw_Resonator(prog);
  }
  else if (Sender == MainForm->Eq5Amp1) EqBarChange(MainForm->Eq5Amp1, MainForm->Eq5Amp1Val, &QuadtGT_Bank[bank][prog].eq.low_amp);
  else if (Sender == MainForm->Eq5Amp2) EqBarChange(MainForm->Eq5Amp2, MainForm->Eq5Amp2Val, &QuadtGT_Bank[bank][prog].eq.low_mid_amp);
  else if (Sender == MainForm->Eq5Amp3) EqBarChange(MainForm->Eq5Amp3, MainForm->Eq5Amp3Val, &QuadtGT_Bank[bank][prog].eq.mid_amp);
  else if (Sender == MainForm->Eq5Amp4) EqBarChange(MainForm->Eq5Amp4, MainForm->Eq5Amp4Val, &QuadtGT_Bank[bank][prog].eq.high_mid_amp);
  else if (Sender == MainForm->Eq5Amp5) EqBarChange(MainForm->Eq5Amp5, MainForm->Eq5Amp5Val, &QuadtGT_Bank[bank][prog].eq.high_amp);

  else if (Sender == MainForm->Eq5Freq1) HorizBarChange(MainForm->Eq5Freq1, MainForm->Eq5Freq1Val, &QuadtGT_Bank[bank][prog].eq.low_freq);
  else if (Sender == MainForm->Eq5Freq2) HorizBarChange(MainForm->Eq5Freq2, MainForm->Eq5Freq2Val, &QuadtGT_Bank[bank][prog].eq.low_mid_freq);
  else if (Sender == MainForm->Eq5Freq3) HorizBarChange(MainForm->Eq5Freq3, MainForm->Eq5Freq3Val, &QuadtGT_Bank[bank][prog].eq.mid_freq);
  else if (Sender == MainForm->Eq5Freq4) HorizBarChange(MainForm->Eq5Freq4, MainForm->Eq5Freq4Val, &QuadtGT_Bank[bank][prog].eq.high_mid_freq);
  else if (Sender == MainForm->Eq5Freq5) HorizBarChange(MainForm->Eq5Freq5, MainForm->Eq5Freq5Val, &QuadtGT_Bank[bank][prog].eq.high_freq);

  else if (Sender == MainForm->Eq5Q2) HorizBarChangeU8(MainForm->Eq5Q2, MainForm->Eq5Q2Val, &QuadtGT_Bank[bank][prog].eq.low_mid_q);
  else if (Sender == MainForm->Eq5Q3) HorizBarChangeU8(MainForm->Eq5Q3, MainForm->Eq5Q3Val, &QuadtGT_Bank[bank][prog].eq.mid_q);
  else if (Sender == MainForm->Eq5Q4) HorizBarChangeU8(MainForm->Eq5Q4, MainForm->Eq5Q4Val, &QuadtGT_Bank[bank][prog].eq.high_mid_q);
  ...
  else if (Sender == MainForm->ModSpeed) VertBarChangeU8((TTrackBar *)Sender, MainForm->ModSpeedVal, &QuadtGT_Bank[bank][prog].pan.speed);
  else if (Sender == MainForm->ModDepth) VertBarChangeU8((TTrackBar *)Sender, MainForm->ModDepthVal, &QuadtGT_Bank[bank][prog].pan.depth);
  ...
  // Pitch parameters
  else if (Sender == MainForm->PitchMode) { QuadtGT_Bank[bank][prog].pitch.mode=MainForm->PitchMode->ItemIndex; QuadGT_Redraw_Pitch(prog);}
  else if (Sender == MainForm->PitchInput){ QuadtGT_Bank[bank][prog].pitch.input=MainForm->PitchInput->ItemIndex;  QuadGT_Redraw_Pitch(prog);}
  ...
  else if (Sender == MainForm->PitchFeedback) VertBarChangeU8((TTrackBar *)Sender, MainForm->PitchFeedbackVal, &QuadtGT_Bank[bank][prog].pitch.feedback);
  ...
  // Reverb parameters
  else if (Sender == MainForm->ReverbPreDelay)  VertBarChangeOffsetU8((TTrackBar *)Sender,  MainForm->ReverbPreDelayVal,       &QuadtGT_Bank[bank][prog].reverb.predelay, 1);
  else if (Sender == MainForm->ReverbDecay)     VertBarChangeU8((TTrackBar *)Sender,  MainForm->ReverbDecayVal,          &QuadtGT_Bank[bank][prog].reverb.decay);
  else if (Sender == MainForm->ReverbLowDecay)  VertBarChangeU8((TTrackBar *)Sender,  MainForm->ReverbLowDecayVal,       &QuadtGT_Bank[bank][prog].reverb.low_decay);
  else if (Sender == MainForm->ReverbHighDecay) VertBarChangeU8((TTrackBar *)Sender,  MainForm->ReverbHighDecayVal,      &QuadtGT_Bank[bank][prog].reverb.high_decay);
  else if (Sender == MainForm->ReverbDensity)   VertBarChangeU8((TTrackBar *)Sender,  MainForm->ReverbDensityVal,        &QuadtGT_Bank[bank][prog].reverb.density);
  else if (Sender == MainForm->ReverbDiffusion) VertBarChangeU8((TTrackBar *)Sender,  MainForm->ReverbDiffusionVal,      &QuadtGT_Bank[bank][prog].reverb.diffusion);
  else if (Sender == MainForm->ReverbGateHold)  VertBarChangeU8((TTrackBar *)Sender,  MainForm->ReverbGateHoldVal,       &QuadtGT_Bank[bank][prog].reverb.gate_hold);
  else if (Sender == MainForm->ReverbGateRelease)  VertBarChangeU8((TTrackBar *)Sender,  MainForm->ReverbGateReleaseVal, &QuadtGT_Bank[bank][prog].reverb.gate_release);
  else if (Sender == MainForm->ReverbGateLevel)  VertBarChangeU8((TTrackBar *)Sender,  MainForm->ReverbGateLevelVal,     &QuadtGT_Bank[bank][prog].reverb.gated_level);
  else if (Sender == MainForm->ReverbInMix)     HorizBarChangeS8((TTrackBar *)Sender, MainForm->ReverbInMixVal,          &QuadtGT_Bank[bank][prog].reverb.input_mix);
  else if (Sender == MainForm->ReverbPreMix)    HorizBarChangeS8((TTrackBar *)Sender, MainForm->ReverbPreMixVal,         &QuadtGT_Bank[bank][prog].reverb.predelay_mix);

  // Delay Parameters
  else if (Sender == MainForm->TapDelay) VertBarChangeU8((TTrackBar *)Sender, MainForm->TapDelayVal, &QuadtGT_Bank[bank][prog].tap.delay[tap]);
  else if (Sender == MainForm->TapPan) VertBarChangeU8((TTrackBar *)Sender, MainForm->TapPanVal, &QuadtGT_Bank[bank][prog].tap.pan[tap]);
  else if (Sender == MainForm->TapVol) VertBarChangeU8((TTrackBar *)Sender, MainForm->TapVolVal, &QuadtGT_Bank[bank][prog].tap.volume[tap]);
  else if (Sender == MainForm->TapFeedback) VertBarChangeU8((TTrackBar *)Sender, MainForm->TapFeedbackVal, &QuadtGT_Bank[bank][prog].tap.feedback[tap]);
  ...
  else if (Sender == MainForm->RingModSS)     VertBarChangeU16((TTrackBar *)Sender, MainForm->RingModSSVal,    &QuadtGT_Bank[bank][prog].ring_mod.shift);
  else if (Sender == MainForm->RingModInMix)  VertBarChangeS8((TTrackBar *)Sender, MainForm->RingModInMixVal,  &QuadtGT_Bank[bank][prog].ring_mod.in_mix);
  else if (Sender == MainForm->RingModOutMix) VertBarChangeS8((TTrackBar *)Sender, MainForm->RingModOutMixVal, &QuadtGT_Bank[bank][prog].ring_mod.out_mix);
}
...
UInt32 QuadGT_Convert_Data_From_Internal(UInt8 prog, UInt8* data)
{
  ...
  if ((QuadtGT_Bank[bank][prog].config == CFG0_EQ_PITCH_DELAY_REVERB) &&
      (QuadtGT_Bank[bank][prog].eq.mode == EQMODE1_EQ_PLUS_RESONATOR))
  {
  ...
  {
    data[GEQ_16HZ_IDX] = QuadtGT_Bank[bank][prog].eq.graphic_16hz + GEQ_OFFSET;
    data[GEQ_32HZ_IDX] = QuadtGT_Bank[bank][prog].eq.graphic_32hz + GEQ_OFFSET;
    data[GEQ_62HZ_IDX] = QuadtGT_Bank[bank][prog].eq.graphic_62hz + GEQ_OFFSET;
                         
    data[GEQ_4KHZ_IDX] = QuadtGT_Bank[bank][prog].eq.graphic_4khz + GEQ_OFFSET;
    data[GEQ_8KHZ_IDX] = QuadtGT_Bank[bank][prog].eq.graphic_8khz + GEQ_OFFSET;
  }
  // 3 and 5 Band Eq
  else
  {
    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].eq.low_freq, &data[LOW_EQ_FREQ_IDX]);
    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].eq.low_amp, &data[LOW_EQ_AMP_IDX]);

    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].eq.high_freq, &data[HIGH_EQ_FREQ_IDX]);
  }

  if (QuadtGT_Bank[bank][prog].config==CFG2_GEQ_DELAY)
  {
    data[GEQ_126HZ_IDX] = QuadtGT_Bank[bank][prog].eq.graphic_126hz + GEQ_OFFSET;
    data[GEQ_250HZ_IDX] = QuadtGT_Bank[bank][prog].eq.graphic_250hz + GEQ_OFFSET;
    data[GEQ_500HZ_IDX] = QuadtGT_Bank[bank][prog].eq.graphic_500hz + GEQ_OFFSET;
    data[GEQ_1KHZ_IDX]  = QuadtGT_Bank[bank][prog].eq.graphic_1khz  + GEQ_OFFSET;
    data[GEQ_2KHZ_IDX]  = QuadtGT_Bank[bank][prog].eq.graphic_2khz  + GEQ_OFFSET;
                        
    data[GEQ_16KHZ_IDX] = QuadtGT_Bank[bank][prog].eq.graphic_16khz + GEQ_OFFSET;
  }
  else
  {
    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].eq.mid_freq, &data[MID_EQ_FREQ_IDX]);
    data[MID_EQ_BW_IDX] = QuadtGT_Bank[bank][prog].eq.mid_q;
    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].eq.mid_amp, &data[MID_EQ_AMP_IDX]);

    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].eq.high_amp, &data[HIGH_EQ_AMP_IDX]);
  }
  ...
  {
    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].eq.low_mid_freq, &data[LOW_MID_EQ_FREQ_IDX]);
    data[LOW_MID_EQ_BW_IDX] = QuadtGT_Bank[bank][prog].eq.low_mid_q;
    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].eq.low_mid_amp, &data[LOW_MID_EQ_AMP_IDX]);
    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].eq.high_mid_freq, &data[HIGH_MID_EQ_FREQ_IDX]);
    data[HIGH_MID_EQ_BW_IDX] = QuadtGT_Bank[bank][prog].eq.high_mid_q;
    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].eq.high_mid_amp, &data[HIGH_MID_EQ_AMP_IDX]);
  }
  ...
  else 
  {
    if (QuadtGT_Bank[bank][prog].config == CFG1_LESLIE_DELAY_REVERB)
    {
      data[LESLIE_HIGH_ROTOR_LEVEL_IDX] = QuadtGT_Bank[bank][prog].leslie.high_rotor_level;
      data[LESLIE_MOTOR_IDX]            = QuadtGT_Bank[bank][prog].leslie.motor;
      data[LESLIE_SPEED_IDX]            = QuadtGT_Bank[bank][prog].leslie.speed;
    }
    else
    {
      QuadGT_Encode_16Bit_Split(QuadtGT_Bank[bank][prog].tap.delay[0], &data[TAP1_DELAY_MSB_IDX],
                                                               &data[TAP1_DELAY_LSB_IDX]);
      QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].tap.delay[1], &data[TAP2_DELAY_IDX]);
    }

    data[TAP1_VOLUME_IDX]   = QuadtGT_Bank[bank][prog].tap.volume[0];
    data[TAP1_PAN_IDX]      = QuadtGT_Bank[bank][prog].tap.pan[0];

    data[DETUNE_AMOUNT_IDX] = QuadtGT_Bank[bank][prog].pitch.detune_amount;

    data[TAP2_VOLUME_IDX]   = QuadtGT_Bank[bank][prog].tap.volume[1];
    data[TAP3_FEEDBACK_IDX] = QuadtGT_Bank[bank][prog].tap.feedback[2];

    if (QuadtGT_Bank[bank][prog].config == CFG3_5BANDEQ_PITCH_DELAY)
    {
      QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].tap.delay[3], &data[TAP4_DELAY_IDX]);
    }
    else
    {
      data[REVERB_MODE_IDX]   = QuadtGT_Bank[bank][prog].reverb.mode;
    }
  }

  if (QuadtGT_Bank[bank][prog].config == CFG1_LESLIE_DELAY_REVERB)
  {
    data[LESLIE_SEPARATION_IDX]       = QuadtGT_Bank[bank][prog].leslie.seperation;
  }
  else
  {
    data[TAP1_FEEDBACK_IDX] = QuadtGT_Bank[bank][prog].tap.feedback[0];
  }

  data[TAP4_VOLUME_IDX]   = QuadtGT_Bank[bank][prog].tap.volume[3];

  if (QuadtGT_Bank[bank][prog].config == CFG3_5BANDEQ_PITCH_DELAY)
  {
    data[TAP4_PAN_IDX]      = QuadtGT_Bank[bank][prog].tap.pan[3];
    data[TAP4_FEEDBACK_IDX] = QuadtGT_Bank[bank][prog].tap.feedback[3];

    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].tap.delay[4], &data[TAP5_DELAY_IDX]);
    data[TAP5_VOLUME_IDX]   = QuadtGT_Bank[bank][prog].tap.volume[4];
    data[TAP5_PAN_IDX]      = QuadtGT_Bank[bank][prog].tap.pan[4];
    data[TAP5_FEEDBACK_IDX] = QuadtGT_Bank[bank][prog].tap.feedback[4];

    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].tap.delay[5], &data[TAP6_DELAY_IDX]);
    data[TAP6_VOLUME_IDX]   = QuadtGT_Bank[bank][prog].tap.volume[5];
    data[TAP6_PAN_IDX]      = QuadtGT_Bank[bank][prog].tap.pan[5];
    data[TAP6_FEEDBACK_IDX] = QuadtGT_Bank[bank][prog].tap.feedback[5];

    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].tap.delay[6], &data[TAP7_DELAY_IDX]);
    data[TAP7_VOLUME_IDX]   = QuadtGT_Bank[bank][prog].tap.volume[6];
    data[TAP7_PAN_IDX]      = QuadtGT_Bank[bank][prog].tap.pan[6];
  }
  else
  {
    data[REVERB_INPUT_1_IDX]=     QuadtGT_Bank[bank][prog].reverb.input_1	;
    data[REVERB_INPUT_2_IDX]=     QuadtGT_Bank[bank][prog].reverb.input_2	;
    data[REVERB_INPUT_MIX_IDX]=   QuadtGT_Bank[bank][prog].reverb.input_mix+99;
    data[REVERB_PREDELAY_IDX]=    QuadtGT_Bank[bank][prog].reverb.predelay	;
    data[REVERB_PREDELAY_MIX_IDX]=QuadtGT_Bank[bank][prog].reverb.predelay_mix+99;
    data[REVERB_DECAY_IDX]=       QuadtGT_Bank[bank][prog].reverb.decay	;
    data[REVERB_DIFFUSION_IDX]=   QuadtGT_Bank[bank][prog].reverb.diffusion	;
    data[REVERB_LOW_DECAY_IDX]=   QuadtGT_Bank[bank][prog].reverb.low_decay	;
    data[REVERB_HIGH_DECAY_IDX]=  QuadtGT_Bank[bank][prog].reverb.high_decay	;
    data[REVERB_DENSITY_IDX]=     QuadtGT_Bank[bank][prog].reverb.density	;
    data[REVERB_GATE_IDX]=        QuadtGT_Bank[bank][prog].reverb.gate	;
    data[REVERB_GATE_HOLD_IDX]=   QuadtGT_Bank[bank][prog].reverb.gate_hold	;
    data[REVERB_GATE_RELEASE_IDX]=QuadtGT_Bank[bank][prog].reverb.gate_release;
    data[REVERB_GATED_LEVEL_IDX]= QuadtGT_Bank[bank][prog].reverb.gated_level	;

    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].ring_mod.shift, &data[RING_MOD_SHIFT_IDX]);
  }

   data[MULTITAP_MASTER_FEEDBACK_IDX] = QuadtGT_Bank[bank][prog].multitap.master_feedback;
   data[MULTITAP_NUMBER_IDX]          = QuadtGT_Bank[bank][prog].multitap.number;

  //-------------------------------------------------------------------------
  // Pitch Parameters (0x1A - 
  //-------------------------------------------------------------------------
  data[PITCH_MODE_IDX]   = QuadtGT_Bank[bank][prog].pitch.mode;
  data[PITCH_FEEDBACK_IDX] =  QuadtGT_Bank[bank][prog].pitch.feedback;

  data[PITCH_INPUT_IDX]  = QuadtGT_Bank[bank][prog].pitch.input & BIT0;
  ...
  data[EQ_PRESET_IDX]   |= (QuadtGT_Bank[bank][prog].eq.preset << 1) & BITS1to7;
  ...
  else
  {
    ...
    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].tap.delay[7], &data[TAP8_DELAY_IDX]);
    data[TAP8_VOLUME_IDX]  = QuadtGT_Bank[bank][prog].tap.volume[7];
    data[TAP8_PAN_IDX]     = QuadtGT_Bank[bank][prog].tap.pan[7];
    data[TAP8_FEEDBACK_IDX]= QuadtGT_Bank[bank][prog].tap.feedback[7];
  }
  ...
  {
    data[TAP2_PAN_IDX]     = QuadtGT_Bank[bank][prog].tap.pan[1];
    data[TAP2_FEEDBACK_IDX]= QuadtGT_Bank[bank][prog].tap.feedback[1];
    QuadGT_Encode_16Bit(QuadtGT_Bank[bank][prog].tap.delay[2], &data[TAP3_DELAY_IDX]);
    data[TAP3_VOLUME_IDX]  = QuadtGT_Bank[bank][prog].tap.volume[2];
    data[TAP3_PAN_IDX]     = QuadtGT_Bank[bank][prog].tap.pan[2];
  }
  ...
  if (QuadtGT_Bank[bank][prog].config==CFG5_RINGMOD_DELAY_REVERB)
  {
    data[RING_MOD_OUTPUT_MIX_IDX]  = QuadtGT_Bank[bank][prog].ring_mod.out_mix+99;
    data[RING_MOD_DEL_REV_MIX_IDX] = QuadtGT_Bank[bank][prog].ring_mod.in_mix+99;
  }
  else
  {
  ...
  data[PAN_SPEED_IDX] = QuadtGT_Bank[bank][prog].pan.speed;
  data[PAN_DEPTH_IDX] = QuadtGT_Bank[bank][prog].pan.depth;
  ...
  data[EQ_MODE_IDX]     |= (QuadtGT_Bank[bank][prog].eq.mode<<7) & BIT7;
  ...
  data[PREAMP_TONE_IDX] |= (QuadtGT_Bank[bank][prog].preamp.tone  << 2) & BITS2to3;
  ...
  data[PREAMP_GATE_IDX]      |= (QuadtGT_Bank[bank][prog].preamp.gate & BITS0to4);

  data[PREAMP_OUT_LEVEL_IDX] = QuadtGT_Bank[bank][prog].preamp.out_level;
...
UInt32 QuadGT_Convert_QuadGT_To_Internal(UInt8 prog, UInt8* data)
{
  ...
  QuadtGT_Bank[bank][prog].pitch.mode    = data[PITCH_MODE_IDX];
  ...
  QuadtGT_Bank[bank][prog].preamp.tone      = (data[PREAMP_TONE_IDX] & BITS2to3) >> 2;
  ...
  QuadtGT_Bank[bank][prog].preamp.gate      = (data[PREAMP_GATE_IDX] & BITS0to4);
  QuadtGT_Bank[bank][prog].preamp.out_level = data[PREAMP_OUT_LEVEL_IDX];

  //-------------------------------------------------------------------------
  // Eq Parameters
  //-------------------------------------------------------------------------
  QuadtGT_Bank[bank][prog].eq.preset = (data[EQ_PRESET_IDX]&BITS1to7)>>1;       // User or Preset 1-6
  ...
  {
    QuadtGT_Bank[bank][prog].eq.graphic_16hz   = data[GEQ_16HZ_IDX]-GEQ_OFFSET;
    QuadtGT_Bank[bank][prog].eq.graphic_32hz   = data[GEQ_32HZ_IDX]-GEQ_OFFSET;
    QuadtGT_Bank[bank][prog].eq.graphic_62hz   = data[GEQ_62HZ_IDX]-GEQ_OFFSET;

    QuadtGT_Bank[bank][prog].eq.graphic_4khz   = data[GEQ_4KHZ_IDX]-GEQ_OFFSET;
    QuadtGT_Bank[bank][prog].eq.graphic_8khz   = data[GEQ_8KHZ_IDX]-GEQ_OFFSET;
  }
  // 3 and 5 Band Eq
  else
  {
    QuadtGT_Bank[bank][prog].eq.low_freq   = QuadGT_Decode_16Bit(&data[LOW_EQ_FREQ_IDX]);
    QuadtGT_Bank[bank][prog].eq.low_amp    = QuadGT_Decode_16Bit(&data[LOW_EQ_AMP_IDX]);
    QuadtGT_Bank[bank][prog].eq.high_freq  = QuadGT_Decode_16Bit(&data[HIGH_EQ_FREQ_IDX]);
  }

  if (QuadtGT_Bank[bank][prog].config==CFG2_GEQ_DELAY)
  {
    QuadtGT_Bank[bank][prog].eq.graphic_126hz  = data[GEQ_126HZ_IDX]-GEQ_OFFSET;
    QuadtGT_Bank[bank][prog].eq.graphic_250hz  = data[GEQ_250HZ_IDX]-GEQ_OFFSET;
    QuadtGT_Bank[bank][prog].eq.graphic_500hz  = data[GEQ_500HZ_IDX]-GEQ_OFFSET;
    QuadtGT_Bank[bank][prog].eq.graphic_1khz   = data[GEQ_1KHZ_IDX]-GEQ_OFFSET;
    QuadtGT_Bank[bank][prog].eq.graphic_2khz   = data[GEQ_2KHZ_IDX]-GEQ_OFFSET;

    QuadtGT_Bank[bank][prog].eq.graphic_16khz  = data[GEQ_16KHZ_IDX]-GEQ_OFFSET;
  }
  else
  {
    QuadtGT_Bank[bank][prog].eq.mid_freq   = QuadGT_Decode_16Bit(&data[MID_EQ_FREQ_IDX]);
    QuadtGT_Bank[bank][prog].eq.mid_amp    = QuadGT_Decode_16Bit(&data[MID_EQ_AMP_IDX]);
    QuadtGT_Bank[bank][prog].eq.mid_q      = data[MID_EQ_BW_IDX];
    QuadtGT_Bank[bank][prog].eq.high_amp   = QuadGT_Decode_16Bit(&data[HIGH_EQ_AMP_IDX]);
  }
  ...
  {
    QuadtGT_Bank[bank][prog].eq.low_mid_freq   = QuadGT_Decode_16Bit(&data[LOW_MID_EQ_FREQ_IDX]);
    QuadtGT_Bank[bank][prog].eq.low_mid_amp    = QuadGT_Decode_16Bit(&data[LOW_MID_EQ_AMP_IDX]);
    QuadtGT_Bank[bank][prog].eq.low_mid_q      = data[LOW_MID_EQ_BW_IDX];

    QuadtGT_Bank[bank][prog].eq.high_mid_freq   = QuadGT_Decode_16Bit(&data[HIGH_MID_EQ_FREQ_IDX]);
    QuadtGT_Bank[bank][prog].eq.high_mid_amp    = QuadGT_Decode_16Bit(&data[HIGH_MID_EQ_AMP_IDX]);
    QuadtGT_Bank[bank][prog].eq.high_mid_q      = data[HIGH_MID_EQ_BW_IDX];
  }
  ...
  else
  {
    if (QuadtGT_Bank[bank][prog].config == CFG1_LESLIE_DELAY_REVERB)
    {
      QuadtGT_Bank[bank][prog].leslie.high_rotor_level = data[LESLIE_HIGH_ROTOR_LEVEL_IDX];
      QuadtGT_Bank[bank][prog].leslie.motor            = data[LESLIE_MOTOR_IDX];
      QuadtGT_Bank[bank][prog].leslie.speed            = data[LESLIE_SPEED_IDX];
    }
    else
    {
      QuadtGT_Bank[bank][prog].tap.delay[0] = QuadGT_Decode_16Bit_Split(&data[TAP1_DELAY_MSB_IDX],
                                                                &data[TAP1_DELAY_LSB_IDX]);
      QuadtGT_Bank[bank][prog].tap.delay[1] = QuadGT_Decode_16Bit(&data[TAP2_DELAY_IDX]);
    }

    QuadtGT_Bank[bank][prog].tap.volume[0] = data[TAP1_VOLUME_IDX];
    QuadtGT_Bank[bank][prog].tap.pan[0]    = data[TAP1_PAN_IDX];

    QuadtGT_Bank[bank][prog].pitch.detune_amount = data[DETUNE_AMOUNT_IDX];

    QuadtGT_Bank[bank][prog].tap.volume[1] = data[TAP2_VOLUME_IDX];
    QuadtGT_Bank[bank][prog].tap.feedback[2] = data[TAP3_FEEDBACK_IDX];

    if (QuadtGT_Bank[bank][prog].config == CFG3_5BANDEQ_PITCH_DELAY)
    {
      QuadtGT_Bank[bank][prog].tap.delay[3] = QuadGT_Decode_16Bit(&data[TAP4_DELAY_IDX]);
    }
  }

  if (QuadtGT_Bank[bank][prog].config == CFG1_LESLIE_DELAY_REVERB)
  {
    QuadtGT_Bank[bank][prog].leslie.seperation = data[LESLIE_SEPARATION_IDX];
  }
  else
  {
    QuadtGT_Bank[bank][prog].tap.feedback[0] = data[TAP1_FEEDBACK_IDX];
  }

  QuadtGT_Bank[bank][prog].tap.volume[3] = data[TAP4_VOLUME_IDX];

  if (QuadtGT_Bank[bank][prog].config == CFG3_5BANDEQ_PITCH_DELAY)
  {
    QuadtGT_Bank[bank][prog].tap.pan[3]      = data[TAP4_PAN_IDX];
    QuadtGT_Bank[bank][prog].tap.feedback[3] = data[TAP4_FEEDBACK_IDX];

    QuadtGT_Bank[bank][prog].tap.delay[4] = QuadGT_Decode_16Bit(&data[TAP5_DELAY_IDX]);
    QuadtGT_Bank[bank][prog].tap.volume[4] = data[TAP5_VOLUME_IDX];
    QuadtGT_Bank[bank][prog].tap.pan[4]      = data[TAP5_PAN_IDX];
    QuadtGT_Bank[bank][prog].tap.feedback[4] = data[TAP5_FEEDBACK_IDX];

    QuadtGT_Bank[bank][prog].tap.delay[5] = QuadGT_Decode_16Bit(&data[TAP6_DELAY_IDX]);
    QuadtGT_Bank[bank][prog].tap.volume[5] = data[TAP6_VOLUME_IDX];
    QuadtGT_Bank[bank][prog].tap.pan[5]      = data[TAP6_PAN_IDX];
    QuadtGT_Bank[bank][prog].tap.feedback[5] = data[TAP6_FEEDBACK_IDX];

    QuadtGT_Bank[bank][prog].tap.delay[6] = QuadGT_Decode_16Bit(&data[TAP7_DELAY_IDX]);
    QuadtGT_Bank[bank][prog].tap.volume[6] = data[TAP7_VOLUME_IDX];
    QuadtGT_Bank[bank][prog].tap.pan[6]      = data[TAP7_PAN_IDX];
  }
  else
  {
    //-------------------------------------------------------------------------
    // Reverb Parameters
    //-------------------------------------------------------------------------
    QuadtGT_Bank[bank][prog].reverb.input_1	        = data[REVERB_INPUT_1_IDX];
    QuadtGT_Bank[bank][prog].reverb.input_2	        = data[REVERB_INPUT_2_IDX];
    QuadtGT_Bank[bank][prog].reverb.input_mix	        = data[REVERB_INPUT_MIX_IDX]-99;
    QuadtGT_Bank[bank][prog].reverb.predelay	        = data[REVERB_PREDELAY_IDX];
    QuadtGT_Bank[bank][prog].reverb.predelay_mix	= data[REVERB_PREDELAY_MIX_IDX]-99;
    QuadtGT_Bank[bank][prog].reverb.decay	        = data[REVERB_DECAY_IDX];
    QuadtGT_Bank[bank][prog].reverb.diffusion	        = data[REVERB_DIFFUSION_IDX];
    QuadtGT_Bank[bank][prog].reverb.low_decay	        = data[REVERB_LOW_DECAY_IDX];
    QuadtGT_Bank[bank][prog].reverb.high_decay	= data[REVERB_HIGH_DECAY_IDX];
    QuadtGT_Bank[bank][prog].reverb.density	        = data[REVERB_DENSITY_IDX];
    QuadtGT_Bank[bank][prog].reverb.gate	        = data[REVERB_GATE_IDX];
    QuadtGT_Bank[bank][prog].reverb.gate_hold	        = data[REVERB_GATE_HOLD_IDX];
    QuadtGT_Bank[bank][prog].reverb.gate_release	= data[REVERB_GATE_RELEASE_IDX];
    QuadtGT_Bank[bank][prog].reverb.gated_level	= data[REVERB_GATED_LEVEL_IDX];

    QuadtGT_Bank[bank][prog].ring_mod.shift = QuadGT_Decode_16Bit(&data[RING_MOD_SHIFT_IDX]);
  }

  QuadtGT_Bank[bank][prog].multitap.master_feedback = data[MULTITAP_MASTER_FEEDBACK_IDX];
  QuadtGT_Bank[bank][prog].multitap.number          = data[MULTITAP_NUMBER_IDX];

  //-------------------------------------------------------------------------
  // Pitch Parameters
  //-------------------------------------------------------------------------
  QuadtGT_Bank[bank][prog].pitch.input   = data[PITCH_INPUT_IDX] & BIT0;
  ...
  else
  {
    ...
    QuadtGT_Bank[bank][prog].tap.delay[7] = QuadGT_Decode_16Bit(&data[TAP8_DELAY_IDX]);
    QuadtGT_Bank[bank][prog].tap.volume[7] = data[TAP8_VOLUME_IDX];
    QuadtGT_Bank[bank][prog].tap.pan[7]    = data[TAP8_PAN_IDX];
    QuadtGT_Bank[bank][prog].tap.feedback[7]= data[TAP8_FEEDBACK_IDX];
  }
  QuadtGT_Bank[bank][prog].pitch.feedback= data[PITCH_FEEDBACK_IDX];
  ...
  {
    QuadtGT_Bank[bank][prog].tap.pan[1]      = data[TAP2_PAN_IDX];
    QuadtGT_Bank[bank][prog].tap.feedback[1] = data[TAP2_FEEDBACK_IDX];
    QuadtGT_Bank[bank][prog].tap.delay[2]    = QuadGT_Decode_16Bit(&data[TAP3_DELAY_IDX]);
    QuadtGT_Bank[bank][prog].tap.volume[2]   = data[TAP3_VOLUME_IDX];
    QuadtGT_Bank[bank][prog].tap.pan[2]      = data[TAP3_PAN_IDX];
  }
  ...
  if (QuadtGT_Bank[bank][prog].config==CFG5_RINGMOD_DELAY_REVERB)
  {
    QuadtGT_Bank[bank][prog].ring_mod.out_mix = data[RING_MOD_OUTPUT_MIX_IDX]-99;
    QuadtGT_Bank[bank][prog].ring_mod.in_mix= data[RING_MOD_DEL_REV_MIX_IDX]-99;
  }
  else
  {
  ...
  QuadtGT_Bank[bank][prog].pan.speed = data[PAN_SPEED_IDX];
  QuadtGT_Bank[bank][prog].pan.depth = data[PAN_DEPTH_IDX];
  //-------------------------------------------------------------------------
...
void __fastcall TMainForm::QuadBankLoadClick(TObject *Sender)
{
  ...
  FormDebug->Log(NULL, "Size "+AnsiString(sizeof(QuadtGT_Bank[0][0])));
   ...
   if (sysex.buffer != NULL)
   {
     if (memcmp(Sysex_Start, sysex.buffer+offset, sizeof(Sysex_Start))==0)
     {
	   ...
	   offset+=1;
	     ...
	     FormDebug->Log(NULL, "Rx Sysex code: "+AnsiString(code)+" - ignored");
           }
	 }
...
//---------------------------------------------------------------------------
// Name        : QuadGT_Data_Process
// Description : Process a Data message from an Alesis Quadraverb or 
//               QuadraverbGT.  
// Parameter 1 : Data payload (words 1 and 2 only)
// Returns     : NONE.
//---------------------------------------------------------------------------
void QuadGT_Data_Process(tData data)
{
  UInt16 word1 = data.p1 & WORD_MASK;
  UInt16 word2 = (data.p1>>WORD_SHIFT) & WORD_MASK;
  FormDebug->Log(NULL, "Got words "+AnsiString(word1)+" "+AnsiString(word2));

  if (MainForm->FollowDevice->Checked==TRUE)
  {
    UInt8 byte1=word1 & BYTE_MASK;
    UInt8 byte2=(word1>>BYTE_SHIFT)&BYTE_MASK;

    if (byte1==Data_Prog_Change)
    {
      QuadGT_Redraw_Patch(MainForm->QuadBank->ItemIndex, byte2);
    }
    // TBD: Handle other edits from the Quadraverb?
  }
}
...
void QuadGT_Copy(const int param, const int bankfrom, const int patchfrom, const int bankto, const int patchto)
{
  ...
  {
    case Param_Preamp:
      QuadtGT_Bank[bankto][patchto].preamp = QuadtGT_Bank[bankfrom][patchfrom].preamp;
      break;

    case Param_Mix:
      QuadtGT_Bank[bankto][patchto].mix = QuadtGT_Bank[bankfrom][patchfrom].mix;
      break;

    case Param_Mod:
      QuadtGT_Bank[bankto][patchto].mod = QuadtGT_Bank[bankfrom][patchfrom].mod;
      break;

    case Param_Reverb:
      QuadtGT_Bank[bankto][patchto].reverb = QuadtGT_Bank[bankfrom][patchfrom].reverb;
      break;

    case Param_Pitch:
      QuadtGT_Bank[bankto][patchto].pitch = QuadtGT_Bank[bankfrom][patchfrom].pitch;
      break;

    case Param_Eq:
      QuadtGT_Bank[bankto][patchto].eq = QuadtGT_Bank[bankfrom][patchfrom].eq;
      break;

    case Param_Resonator:
      QuadtGT_Bank[bankto][patchto].res = QuadtGT_Bank[bankfrom][patchfrom].res;
      break;

    case Param_Delay:
      QuadtGT_Bank[bankto][patchto].delay = QuadtGT_Bank[bankfrom][patchfrom].delay;
      QuadtGT_Bank[bankto][patchto].tap = QuadtGT_Bank[bankfrom][patchfrom].tap;
      QuadtGT_Bank[bankto][patchto].multitap = QuadtGT_Bank[bankfrom][patchfrom].multitap;
      break;

    case Param_Sample:
      QuadtGT_Bank[bankto][patchto].sample = QuadtGT_Bank[bankfrom][patchfrom].sample;
      break;
...
void QuadGT_Compare(const int compare_bank, const int compare_patch)
{
  ...
  FormDebug->Log(NULL,"Compare      Bank" + AnsiString(bank) + " Patch " + AnsiString(prog));
  FormDebug->Log(NULL,"Compare To   Bank" + AnsiString(compare_bank) + " Patch " + AnsiString(compare_patch));
  FormDebug->Log(NULL,"Size " + AnsiString(sizeof(QuadtGT_Bank[compare_bank][compare_patch].preamp)));

  if (QuadtGT_Bank[bank][prog].config != QuadtGT_Bank[compare_bank][compare_patch].config)
    MainForm->QuadConfig->Color=clRed;

  if (memcmp(&QuadtGT_Bank[bank][prog].preamp,
             &QuadtGT_Bank[compare_bank][compare_patch].preamp,
             sizeof(QuadtGT_Bank[compare_bank][compare_patch].preamp)) != 0)
    MainForm->PanelQuadPreamp->Color=clRed;

  if (memcmp(&QuadtGT_Bank[bank][prog].delay,
             &QuadtGT_Bank[compare_bank][compare_patch].delay,
             sizeof(QuadtGT_Bank[compare_bank][compare_patch].delay)) != 0)
    MainForm->PanelQuadDelay->Color=clRed;

  if (memcmp(&QuadtGT_Bank[bank][prog].eq,
             &QuadtGT_Bank[compare_bank][compare_patch].eq,
             sizeof(QuadtGT_Bank[compare_bank][compare_patch].eq)) != 0)
  {
    MainForm->PanelQuadEq3->Color=clRed;
    MainForm->QuadEq5->Color=clRed;
    MainForm->QuadGraphEq->Color=clRed;
  }

  if (memcmp(&QuadtGT_Bank[bank][prog].res,
             &QuadtGT_Bank[compare_bank][compare_patch].res,
             sizeof(QuadtGT_Bank[compare_bank][compare_patch].res)) != 0)
    MainForm->QuadResonator->Color=clRed;

  if (memcmp(&QuadtGT_Bank[bank][prog].mix,
             &QuadtGT_Bank[compare_bank][compare_patch].mix,
             sizeof(QuadtGT_Bank[compare_bank][compare_patch].mix)) != 0)
    MainForm->PanelQuadMix->Color=clRed;

  if (memcmp(&QuadtGT_Bank[bank][prog].mod,
             &QuadtGT_Bank[compare_bank][compare_patch].mod,
             sizeof(QuadtGT_Bank[compare_bank][compare_patch].mod)) != 0)
    MainForm->PanelQuadMod->Color=clRed;

  if (memcmp(&QuadtGT_Bank[bank][prog].leslie,
             &QuadtGT_Bank[compare_bank][compare_patch].leslie,
             sizeof(QuadtGT_Bank[compare_bank][compare_patch].leslie)) != 0)
    MainForm->QuadLeslie->Color=clRed;

  if (memcmp(&QuadtGT_Bank[bank][prog].ring_mod,
             &QuadtGT_Bank[compare_bank][compare_patch].ring_mod,
             sizeof(QuadtGT_Bank[compare_bank][compare_patch].ring_mod)) != 0)
    MainForm->QuadRingMod->Color=clRed;

  if (memcmp(&QuadtGT_Bank[bank][prog].reverb,
             &QuadtGT_Bank[compare_bank][compare_patch].reverb,
             sizeof(QuadtGT_Bank[compare_bank][compare_patch].reverb)) != 0)
    MainForm->QuadReverb->Color=clRed;

  if (memcmp(&QuadtGT_Bank[bank][prog].pitch,
             &QuadtGT_Bank[compare_bank][compare_patch].pitch,
             sizeof(QuadtGT_Bank[compare_bank][compare_patch].pitch)) != 0)
    MainForm->QuadPitch->Color=clRed;

}

void QuadGT_UndoCompare(void)
{
  MainForm->QuadConfig->Color=clBtnFace;
  MainForm->PanelQuadPreamp->Color=clBtnFace;
  MainForm->PanelQuadDelay->Color=clBtnFace;
  MainForm->PanelQuadEq3->Color=clBtnFace;
  MainForm->QuadEq5->Color=clBtnFace;
  MainForm->QuadGraphEq->Color=clBtnFace;
  MainForm->QuadResonator->Color=clBtnFace;
  MainForm->PanelQuadMix->Color=clBtnFace;
  MainForm->PanelQuadMod->Color=clBtnFace;
  MainForm->QuadLeslie->Color=clBtnFace;
  MainForm->QuadRingMod->Color=clBtnFace;
  MainForm->QuadReverb->Color=clBtnFace;
  MainForm->QuadPitch->Color=clBtnFace;
}
